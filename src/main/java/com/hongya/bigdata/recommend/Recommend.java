package com.hongya.bigdata.recommend;
...
public class Recommend extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String flag = request.getParameter("flag");// flag : com.hongya.bigdata.recommend/check
		String recNum =null;
		...
		if("recommend".equals(flag)){
			...
			try {
				rec= SparkDeployUtils.predict(Integer.parseInt(uid),Integer.parseInt(recNum));
			...
			rec = SparkDeployUtils.check(Integer.parseInt(uid));
		}
